...
OpenAlex database through its PostgreSQL server.

Your connection information should have been sent to you by email, and a
demo will be performed in class to show you how to connect and query the
database. If you are having problems accessing the database, contact the
course instructor or TA.

I recommend using [DBeaver](https://dbeaver.io/) to connect and query
the MISTS database, but any PostgreSQL client will do.
